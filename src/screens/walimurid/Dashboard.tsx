    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      {unreadCount > 0 && latestUnread && (
        <div className="bg-gradient-to-r from-amber-500 via-rose-500 to-indigo-600 p-[1.5px] rounded-3xl shadow-lg">
          <div className="bg-white dark:bg-slate-900 rounded-[22px] p-4 sm:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="flex items-start gap-3.5 sm:gap-4 flex-1 min-w-0">
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-rose-50 dark:bg-rose-950/80 text-rose-600 dark:text-rose-400 flex items-center justify-center shrink-0 border border-rose-200 dark:border-rose-900/50 shadow-xs">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-slate-600 dark:text-slate-300 line-clamp-2 mt-1 leading-relaxed break-words">
                  {latestUnread.content}
                </p>
              </div>
            </div>

            <div className="flex items-center gap-2 w-full md:w-auto shrink-0 pt-2 md:pt-0 border-t md:border-t-0 border-slate-100 dark:border-slate-800">
              <button
                onClick={() => {
                  markAsRead(latestUnread.id);
                  setActiveTab('pengumuman');
                }}
                className="flex-1 md:flex-none px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold transition-all shadow-md shadow-indigo-600/20 flex items-center justify-center gap-1.5 cursor-pointer"
              >
              ...
              <button
                ...
                className="px-3.5 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-semibold transition-colors cursor-pointer"
                    ...
                    <div className="flex flex-col sm:flex-row items-start justify-between gap-4">
                      <div className="flex items-start gap-3.5 sm:gap-4 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {/* Content Snippet */}
                          <div className="text-xs sm:text-sm text-slate-700 dark:text-slate-200 bg-slate-50/80 dark:bg-slate-800/60 p-4 rounded-2xl leading-relaxed whitespace-pre-wrap break-words border border-slate-100 dark:border-slate-800/80 mt-2 max-w-full">
                            {item.content}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap sm:flex-col items-center gap-2 shrink-0 self-end sm:self-start w-full sm:w-auto justify-end pt-3 sm:pt-0 border-t sm:border-t-0 border-slate-100 dark:border-slate-800">
                        <button
                          onClick={() => generateAnnouncementPDF(item, schoolSettings)}
                          className="flex-1 sm:flex-none px-3 py-2 bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-950/40 dark:hover:bg-indigo-900/60 text-indigo-700 dark:text-indigo-300 rounded-xl text-xs font-bold transition-all border border-indigo-200 dark:border-indigo-800/60 flex items-center justify-center gap-1.5 cursor-pointer"
                        ...
                        <button
                          ...
                          className="flex-1 sm:flex-none px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-bold transition-all shadow-xs flex items-center justify-center gap-1.5 cursor-pointer"
                        >
                          <span>Rincian</span>
                          <ArrowRight className="w-3.5 h-3.5" />
                        </button>
                        ...
                        <button
                          ...
                          className={`flex-1 sm:flex-none px-3 py-2 rounded-xl text-xs font-semibold transition-colors cursor-pointer ${
                            unread
